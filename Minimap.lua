...
function MinimapButton:CreateDiscord()
    ...
    text(frame, 16, 18, -17, 460, BKA:L("DISCORD_TITLE"))
    text(frame, 12, 18, -45, 480, BKA:L("DISCORD_CONTACT"))
    text(frame, 11, 18, -67, 480, BKA:L("DISCORD_COPY_HINT"))
    ...
    BKA.Options:AddSupportLink(frame, "BOTTOMLEFT", "BOTTOMLEFT", 18, 12, 390)
    frame:Hide()
